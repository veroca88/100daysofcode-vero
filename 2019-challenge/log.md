...
DAY 8 02/19/19.
**Today Progress** I searched for differents ways to do the last exercise because my code was too long, the problem was there were advance way to get it but I want to understand the code to keep going with other one, so I tryed several times, first, I created a function it takes the prime numbers, inside the principal function but then I couldn't find how to explain the next step so I tryed again, finally I found someone who could explain me!!
